...
XS(XS_Unicode__String_latin1); /* prototype to pass -Wmissing-prototypes */
XS(XS_Unicode__String_latin1)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::String::latin1", "self, ...");
...
XS(XS_Unicode__String_ucs4); /* prototype to pass -Wmissing-prototypes */
XS(XS_Unicode__String_ucs4)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::String::ucs4", "self, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV*	self = ST(0);
#line 105 "String.xs"
...
XS(XS_Unicode__String_utf8); /* prototype to pass -Wmissing-prototypes */
XS(XS_Unicode__String_utf8)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::String::utf8", "self, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV*	self = ST(0);
#line 194 "String.xs"
...
XS(XS_Unicode__String_byteswap2); /* prototype to pass -Wmissing-prototypes */
XS(XS_Unicode__String_byteswap2)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
extern "C"
#endif
XS(boot_Unicode__String); /* prototype to pass -Wmissing-prototypes */
XS(boot_Unicode__String)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
